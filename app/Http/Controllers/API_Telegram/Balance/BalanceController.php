...
use App\Http\Requests\API_Telegram\Balance\SecretRequest;
...
class BalanceController extends Controller
{
    ...
    public function secret(SecretRequest $request): JsonResponse
    {
        $data = new SecretDTO($request->validated());

        try {
            $this->service->secret($data);
